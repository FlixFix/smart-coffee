...
cd .. &&
rsync -arv --exclude './backend/.env' ./backend Homepod@192.168.178.94:/var/www/coffee-hub/ &&

echo 'copying frontend static to homepod...'
rsync -arv ./frontend/build Homepod@192.168.178.94:/var/www/coffee-hub/frontend &&
