...
cd .. &&
rsync -arv --exclude './backend/.env' ./backend homepod@192.168.178.22:/var/www/coffee-hub/ &&

echo 'copying frontend static to homepod...'
rsync -arv ./frontend/build homepod@192.168.178.22:/var/www/coffee-hub/frontend &&
